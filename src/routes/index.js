...
const MerchantSettings = lazy(() =>
  import("../pages/authenticated/MerchantSettings"),
);
const DynamicAssignment = lazy(() =>
  import("../pages/authenticated/DynamicAssignment"),
);
const Users = lazy(() => import("../pages/authenticated/Users"));
const DiscountManagement = lazy(() =>
  import("../pages/authenticated/DiscountManagement"),
);
const SmsProvider = lazy(() => import("../pages/authenticated/SmsProvider"));
const Subscriptions = lazy(() =>
  import("../pages/authenticated/Subscriptions"),
);
