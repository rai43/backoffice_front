        ...
        <div className="relative pb-5 flex flex-col h-full">
          ...
          <div className="overflow-y-scroll pl-4 pr-4">
            <div className="flex flex-col w-full">
              ...
              {
                {
                  [RIGHT_DRAWER_TYPES.USER_DETAILS]: (
                    <UserDetailsBodyRightDrawer
                      extraObject={extraObject}
                      closeRightDrawer={close}
                    />
                  ),
                  [RIGHT_DRAWER_TYPES.CLIENT_CARD_DETAILS]: (
                    <ClientWalletDetailView extraObject={extraObject} closeRightDrawer={close} />
                  ),
                  [RIGHT_DRAWER_TYPES.LIVREUR_CARD_DETAILS]: (
                    <LivreurWalletDetailView extraObject={extraObject} closeRightDrawer={close} />
                  ),
                  [RIGHT_DRAWER_TYPES.MERCHANT_SETTINGS_ACCOMPAGNEMENT]: (
                    <AccompagnementAddOrEdit extraObject={extraObject} closeRightDrawer={close} />
                  ),
                  [RIGHT_DRAWER_TYPES.MERCHANT_SETTINGS_ARTICLE]: (
                    <ArticleAddOrEdit extraObject={extraObject} closeRightDrawer={close} />
                  ),
                  [RIGHT_DRAWER_TYPES.MERCHANT_ARTICLE_ADD_EDIT]: (
                    <MenuArticleAddOrEdit extraObject={extraObject} closeRightDrawer={close} />
                  ),
