		...
		<div className=''>
			<div className='flex items-center justify-center'>
				<div className='grid grid-cols-1'>
					<p className='text-warning my-5'>Please Assign a livreur to this command in order to proceed</p>
					...
					{livreur && (
						<button
							...
							onClick={async () => {
								await dispatch(setOrderStatus({ commandId: extraObject?.orderId, livreurId: livreur, isChangeLivreur: extraObject?.isChangeLivreur })).then(async (response) => {
									if (response?.error) {
