...
export const getDiscounts = createAsyncThunk(
  ...
  async (params) => {
    const from =
      params.from || moment.utc().subtract(7, "days").format("YYYY-MM-DD");
...
export const saveDiscounts = createAsyncThunk(
  ...
  async (params) => {
    const fromDisplay =
      params.fromDisplay || moment.utc().subtract(7, "days").toDate();
...
export const updateDiscount = createAsyncThunk(
  ...
  async (params) => {
    ...
    const response = await axios.post(
      `/api/discounts/update-dicount/${discount}`,
      payload,
    );
    return response.data;
  },
...
export const toggleDiscountStatus = createAsyncThunk(
  ...
  async (params) => {
    ...
    const response = await axios.patch(
      `/api/discounts/toggle-discount-status/${discountId}`,
    );
...
export const deleteDiscount = createAsyncThunk(
  ...
  async (params) => {
    ...
    const response = await axios.patch(
      `/api/discounts/delete-discount/${discountId}`,
    );
    return response.data;
  },
);
