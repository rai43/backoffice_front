...
export const getUserTypesContent = createAsyncThunk('/user-types/content', async (params) => {
  const active = params.active;
  const inactive = params.inactive;
  const response = await axios.get(`/api/user-type/get-user-type/${active}/${inactive}`);
