  ...
  const handleOnSubmit = async (values) => {
    ...
    if (response?.error) {
      dispatch(
        showNotification({
          message: extraObject
            ? 'Error while updating the user information'
      ...
      <form onSubmit={formik.handleSubmit}>
        <div className="grid grid-cols-1 md:grid-cols-6 gap-3">
          <InputText
            ...
            inputStyle={`${
              !formik.isValid && formik.touched.prenom && formik.errors.prenom ? 'input-error' : ''
            } `}
          />
          <InputText
            type="text"
            ...
            updateFormValue={updateFormValue}
            inputStyle={`${
              !formik.isValid && formik.touched.nom && formik.errors.nom ? 'input-error' : ''
            } `}
          />
          <InputText
            type="text"
            ...
            updateFormValue={updateFormValue}
            inputStyle={`${
              !formik.isValid && formik.touched.adresse && formik.errors.adresse
                ? 'input-error'
                : ''
            } `}
          />
          ...
          <InputPhoneNumber
            ...
            defaultValue={
              extraObject
                ? (extraObject?.telephone.startsWith('+') ? '' : '+') + extraObject?.telephone
            ...
            updateFormValue={updateFormValue}
            inputStyle={`${
              !formik.isValid && formik.touched.telephone && formik.errors.telephone
                ? 'input-error'
                : ''
            } `}
          />
          <InputText
            ...
            updateFormValue={updateFormValue}
            inputStyle={`${
              !formik.isValid && formik.touched.email && formik.errors.email ? 'input-error' : ''
            } `}
          />
          {!extraObject ? (
            <InputText
              ...
              updateFormValue={updateFormValue}
              inputStyle={`${
                !formik.isValid && formik.touched.password && formik.errors.password
                  ? 'input-error'
                  : ''
              } `}
            />
          ...
          {!extraObject ? (
            <InputText
              ...
              updateFormValue={updateFormValue}
              inputStyle={`${
                !formik.isValid && formik.values.password !== repeatPassword ? 'input-error' : ''
              } `}
            />
          ) : null}
