		...
		<>
			<div className='my-2'>
				<div className='tabs my-1'>
					<button
						className={`tab tab-bordered w-1/2 ${activePage === '/my-wallet/transactions' ? 'tab-active' : ''}`}
						onClick={() => {
					...
					{accountType === 'MARCH' ? (
						<button
							className={`tab tab-bordered w-1/2 ${activePage === '/marchant-wallet/requests' ? 'tab-active' : ''}`}
							onClick={() => {
						...
						<button
							className={`tab tab-bordered w-1/2 ${activePage === '/personal-wallet/rechargements' ? 'tab-active' : ''}`}
							onClick={() => {
