    ...
    <>
      <div className="w-full flex items-center justify-center">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 place-items-center">
          <div
            className={`card w-3/4 h-1/2 bg-white shadow-xl image-full mx-4 hover:cursor-pointer ${
              selectedAccount === 'personal' ? 'border-t-4 border-b-4 border-primary' : ''
            }`}
            onClick={() => setSelectedAccount('personal')}
          >
            <figure>
              <img src={PersonalImageBg} alt="PersonalImageBg" />
            </figure>
          ...
          <div
            className={`card w-3/4 h-1/2 bg-slate-100 shadow-xl image-full mx-4 hover:cursor-pointer ${
              selectedAccount === 'merchant' ? 'border-t-4 border-b-4 border-primary' : ''
            }`}
            onClick={() => setSelectedAccount('merchant')}
          >
            <figure>
              <img src={SellerImageBg} alt="SellerImageBg" />
            </figure>
            <div className="card-body flex items-center justify-center">
